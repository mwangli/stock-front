  ...
  <Row gutter={24}>
    ...
    <Col {...topColResponsiveProps}>
      <ChartCard
        ...
        footer={<Field label="平均收益金额" value={numeral(1234).format('0,0')} />}
        contentHeight={46}
      >
        <TinyArea
          color="#975FE4"
    ...
    <Col {...topColResponsiveProps}>
      <ChartCard
        ...
        footer={<Field label="平均日收益率" value="60%" />}
        contentHeight={46}
      >
      ...
      <ChartCard
        ...
        footer={
          <div style={{ whiteSpace: 'nowrap', overflow: 'hidden' }}>
            <Trend flag="up" style={{ marginRight: 16 }}>
              已用金额
              <span className={styles.trendText}>1230</span>
            </Trend>
            <Trend flag="down">
              可用金额
              <span className={styles.trendText}>3340</span>
            </Trend>
          </div>
        }
        contentHeight={46}
